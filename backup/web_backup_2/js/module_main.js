$(function(){
	...
	$("li").on("click", function(e){
		switch (e.currentTarget.id){
			...
			alert("twitter_linked on entering = " + twitter_linked);
				if(twitter_linked == 0){
					alert("Linking Account");
					alert("twitter_linked = " + twitter_linked);
					twitter_linked = 1;
					alert("twitter_linked = " + twitter_linked);wipePage();
					post('index.php', {
						update_views: [
							"login"
						],
                ...
                alert("twitter_linked on leaving = " + twitter_linked);
                break;
			}
